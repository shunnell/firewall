...
variable "interface_endpoints" {
  ...
  validation {
    condition     = !contains(var.interface_endpoints, "guardduty-data")
    error_message = "'guardduty-data' cannot be included in endpoint list; it will be automatically added via AWS Organizations"
  }
}
